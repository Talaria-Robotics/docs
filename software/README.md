...
***Figure 1:** High-level sequence of events for the delivery system.*
![](./system-sequence.png)
...
***Figure 2:** Visualization of the graph defined in the example floor plan. Stops are shown in green and junctions in red.*
